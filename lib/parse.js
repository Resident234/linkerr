...
module.exports = {
    parse: async (resourceURL, crawlingMode) => {
        ...
        PARSED_INFO.comments     = parseComments(html, ".note", hostURL, resourceURL, baseURL, crawlingMode);//TODO: не могу на php.net насти страницу с комментами , может их вообще убрали
        PARSED_INFO.title        = parseTextInSelector(html, "h1", hostURL, resourceURL, baseURL, crawlingMode);//TODO: не могу на php.net насти страницу с комментами , может их вообще убрали
